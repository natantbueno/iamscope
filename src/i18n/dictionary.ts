...
const SHARED = {
  ...
  'perm.indexesFailed':  { pt: 'Estes índices não carregaram e ficaram de fora da busca — resultado vazio aqui NÃO quer dizer que a permissão não existe:',
                           en: 'These indexes failed to load and are missing from this search — an empty result here does NOT mean the permission does not exist:' },
  'perm.noneFoundFor':   { pt: 'Nenhuma permissão encontrada para',
                           en: 'No permission found for' },
