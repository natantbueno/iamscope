...
export default function CompareFilters({ selectedTiers, visibleClouds, selectedFunction, sortBy }: CompareFiltersProps) {
  ...
  return (
    <div className="px-4 py-3 border-b border-surface-border dark:border-gray-800 bg-white dark:bg-gray-900 shrink-0 space-y-3">
      ...
      {/* Function filter */}
      {/* flex-wrap + min-w-0 nos selects: em 390px os dois lado a lado somavam
          469px e o segundo saia da tela — sem scroll para alcanca-lo. */}
      <div className="flex items-center gap-2 flex-wrap rolagem-chips">
        ...
        <select
          ...
          className="min-w-0 max-w-full text-tiny px-2 py-1 rounded border border-surface-border dark:border-gray-700 bg-white dark:bg-gray-800 text-gray-700 dark:text-gray-300 focus:outline-none focus:border-blue-500">
