...
export default function Pagination({
  ...
  const navBtn = 'p-2 sm:p-1.5 rounded-md border border-surface-border dark:border-gray-700 text-fg-muted '
        ...
        <div className="flex items-center gap-1 ml-auto">
          ...
          {pages.map((p, i) => p === '…' ? (
            ...
            <button
              ...
              className="text-tiny min-w-[32px] min-h-[32px] sm:min-w-[26px] sm:min-h-0 px-1.5 py-1 rounded-md border transition-colors"
              style={p === page
