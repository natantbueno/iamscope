...
export default function StatsBar({ stats }: { stats: StatItem[] }) {
  return (
    <div className="px-4 sm:px-6 py-2 border-b border-surface-border dark:border-gray-800 bg-white dark:bg-gray-900 flex items-center gap-1 flex-wrap rolagem-chips">
      {stats.map((s, i) => {
