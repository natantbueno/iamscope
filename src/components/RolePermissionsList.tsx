                ...
                <tr key={p.action + i} className="border-b border-gray-100 dark:border-gray-800 last:border-0 hover:bg-gray-50 dark:hover:bg-gray-800/50 group">
                  <td className="px-3 py-2 align-top">
                    <div className="flex items-start gap-1.5">
                      <code className="font-mono text-3xs text-accent break-all leading-relaxed">{p.action}</code>
                      <button onClick={() => copy(p.action)}
                        className="p-2 -m-2 reveal-on-hover text-fg-muted dark:text-gray-600 hover:text-gray-600 dark:hover:text-gray-300 shrink-0 mt-0.5 transition-opacity"
                        title={t('action.copy')}>
