                  ...
                  <tr key={row.permission + i}
                        ...
                        <td key={c.key} className="px-3 py-2 align-top">
                          <span
                            className={`${c.mono || isFirst ? 'font-mono text-3xs break-all' : 'text-3xs'} ${
                              isFirst ? 'font-medium text-accent' : 'text-fg-muted'
                            } leading-snug`}
                          >
                            {v || '—'}
                          </span>
                    ...
                    <td className="px-2 py-2 align-top">
                      <button onClick={() => copy(row.permission)} title={t('action.copy')}
                        className="p-2 -m-2 reveal-on-hover text-fg-muted dark:text-gray-600 hover:text-gray-600 dark:hover:text-gray-300 transition-opacity">
