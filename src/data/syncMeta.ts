...
export const DATA_SYNC: DataSourceSync[] = [
  ...
  },
  {
    ...
    notes: 'Recontagem em 31/07: 504 é o número oficial, obtido de 504 blocos "roleName" e 504 GUIDs '
      + 'únicos nos 19 arquivos built-in-roles/*.md. O critério é o que a documentação da Microsoft '
      + 'descreve hoje — role descontinuada, que já saiu de lá, não entra na conta.',
  },
  {
  ...
  {
    id: 'gcp-roles',
    label: 'GCP IAM — Predefined Roles (2.389)',
    platform: 'GCP IAM',
    lastSynced: '2026-07-31',
    ...
    notes: 'Coletado das docs públicas, sem credencial — a IAM API responde 403 sem autenticação, '
      + 'mas as páginas por serviço são renderizadas no servidor. Antes o dataset tinha 232 roles '
      + 'com 6% de cobertura de permissões.',
  },
  {
    id: 'gws-roles',
