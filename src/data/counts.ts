...
// Gerado em: 2026-08-27T21:24:22.477Z
//
...
export const ENTRA_ROLES_COUNT = 144
export const ENTRA_ACTIONS_COUNT = 670
export const ENTRA_API_PERMISSIONS_COUNT = 1536
export const AZURE_ROLES_COUNT = 504
export const AZURE_PROVIDERS_COUNT = 151
export const AWS_POLICIES_COUNT = 1582
export const AWS_ACTIONS_COUNT = 16423
export const AWS_SERVICES_COUNT = 451
export const GCP_ROLES_COUNT = 2389
export const GCP_PERMISSIONS_COUNT = 13701
export const GCP_SERVICES_COUNT = 317
export const GWS_ROLES_COUNT = 14
export const GWS_SCOPES_COUNT = 60
export const GWS_PRIVILEGES_COUNT = 120
