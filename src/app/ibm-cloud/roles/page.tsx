  ...
  return (
    ...
    >
      <div className="flex flex-col flex-1 min-h-0 min-w-0">
        ...
        <div className="px-4 sm:px-6 py-2 border-b border-surface-border dark:border-gray-800 flex items-center gap-3 flex-wrap rolagem-chips shrink-0 bg-gray-50/50 dark:bg-gray-900/50">
