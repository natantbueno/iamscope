                  ...
                  <tr key={role.slug} className="border-b border-line hover:bg-surface-alt/60 transition-colors group">
                    <td className="px-4 py-2.5 align-middle overflow-hidden">
                      <Link href={`/azure-rbac/roles/${role.slug}`}
                        className="text-body font-medium text-accent hover:underline truncate block py-1 -my-1">
                        {role.name}
                      </Link>
                    </td>
                    <td className="px-4 py-2.5 align-middle overflow-hidden">
                    ...
                    <td className="px-4 py-2.5 align-middle">
                      <Link href={`/azure-rbac/roles/${role.slug}`}
                        className="inline-flex items-center justify-center p-2 -m-2 text-gray-600 group-hover:text-brand-onDark transition-colors">
