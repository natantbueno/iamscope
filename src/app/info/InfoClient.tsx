...
const PLATFORMS: { name: string; color: string; desc: TranslationKey }[] = [
  { name: 'Microsoft Entra ID', color: '#0078d4', desc: 'info.platformEntra' },
  { name: 'Azure RBAC',         color: '#5c2d91', desc: 'info.platformAzure' },
  { name: 'Google Cloud (GCP)', color: '#4285f4', desc: 'info.platformGcp' },
  { name: 'Google Workspace',   color: '#34a853', desc: 'info.platformGws' },
  { name: 'AWS IAM',            color: '#ff9900', desc: 'info.platformAws' },
  { name: 'IBM Cloud',          color: '#08bdba', desc: 'info.platformIbm' },
]
