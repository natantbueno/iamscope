 ...
 *
 *   O AzAdvertizer NÃO serve de referência aqui. A página dele cobre várias
 *   resource APIs (tem filtro ?targetAppId=), então o total de ~2.681 não é
 *   comparável com um dataset que é 100% Microsoft Graph.
 *
